...
const { Children, cloneElement, Component, createElement, Fragment, render } = React
const { hydrate } = ReactDOM
const { renderToString, renderToStaticMarkup } = ReactDOMServer

export { Children, cloneElement, Component, createElement, createElement as h, Fragment, hydrate, render, renderToString, renderToStaticMarkup }
